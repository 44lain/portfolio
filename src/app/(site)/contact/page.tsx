...
export default function ContactPage() {
  ...
  return (
    <>
      <PageMarquee text="Contato" repeat={4} ariaLabel="Contato" />
      <section className="content-container grid grid-cols-1 gap-10 section-spacing lg:grid-cols-12">
        <div className="lg:col-span-6">
          <h2 className="text-large-heading text-foreground">Vamos conversar</h2>
          <p className="text-large-body mt-6 text-foreground/90">
